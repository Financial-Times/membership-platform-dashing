...
SCHEDULER.every '30s', first_in: 0 do |job|
  ...
  performCheckAndSendEventToWidgets('user-products-eu', 'usr-product-svc-at-eu-prod.memb.ft.com', '/tests/get-products-critical', true)
  performCheckAndSendEventToWidgets('user-products-us', 'usr-product-svc-at-us-prod.memb.ft.com', '/tests/get-products-critical', true)
