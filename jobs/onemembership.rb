...
SCHEDULER.every '30s', first_in: 0 do |job|
  ...
  performCheckAndSendEventToWidgets('user-products-eu', 'usr-product-svc-at-eu-prod.herokuapp.com', '/tests/get-products-critical', true)
  performCheckAndSendEventToWidgets('user-products-us', 'usr-product-svc-at-us-prod.herokuapp.com', '/tests/get-products-critical', true)
...
SCHEDULER.every '30s', first_in: 0 do |job|
  ...
  performCheckAndSendEventToWidgets('user-id-svc-tests-eu', 'change-me', '/tests', true)
  performCheckAndSendEventToWidgets('user-id-svc-tests-us', 'change-me', '/tests', true)
